...
PVP.teams = {
    test = {"Test1"},
    red = {"clownwolf", "FranzJoseph", "Beta", "-cigarette-", "kitty02", "Elvis26", "danicoo", "Liberty45"},
    blue = {"TenPlusTwo", "Darkf4antom", "AnthonyDe", "SoulSeeker", "JediKnight", "Gladius", "Xenon", "5uper1ach", "PantsMan", "liverpool"},
