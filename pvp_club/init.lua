...
PVP.teams = {
    test = {"Test1"},
    red = {"clownwolf", "FranzJoseph", "Beta", "Rtx", "-cigarette-", "kitty02", "anto", "Elvis26", "Arceus"},
    blue = {"TenPlusTwo", "Darkf4antom", "AnthonyDe", "SoulSeeker", "JediKnight", "Panquesito7", "Gladius", "Xenon", "liverpool", "5uper1ach", "PantsMan"},
